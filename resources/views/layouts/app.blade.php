...
<head>
    ...
    <title>{{ config('app.name', 'Pickuskart') }} - @yield('title', __('eCommerce Store'))</title>
                ...
                <div class="col-md-6 col-12 text-md-end text-center mt-2 mt-md-0">
                    <div class="top-bar-right">
                        ...
                        <div class="dropdown d-inline-block ms-3">
                            <a class="dropdown-toggle top-bar-link" href="#" role="button"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 col-md-5 col-6">
                    <div class="header-icons">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('orders.index') }}"><i
                                                class="bi bi-box-seam me-2"></i> {{ __('My Orders') }}</a></li>
                                    <li><a class="dropdown-item" href="{{ route('reviews.index') }}"><i
                                                class="bi bi-journal-text me-2"></i> {{ __('My Reviews') }}</a></li>
                                    <li>
                        ...
                        @auth('web')
                            @php
                                $wishlistCount = \App\Models\Wishlist::countForUser(auth('web')->id());
                            @endphp

                            <a href="{{ route('wishlist.index') }}" class="header-icon position-relative">
                                <div class="icon-wrapper">
                                    <i class="bi bi-heart"></i>
                                    <span class="icon-badge wishlist-count">{{ $wishlistCount }}</span>
                                    <span class="icon-label d-none d-lg-inline">{{ __('Wishlist') }}</span>
                                </div>
                            </a>
                        @else
                            <a href="{{ route('login') }}" class="header-icon position-relative">
                                <div class="icon-wrapper">
                                    <i class="bi bi-heart"></i>
                        ...
                        <a href="{{ route('cart.index') }}" class="header-icon position-relative">
                            <div class="icon-wrapper">
                                <i class="bi bi-bag"></i>
                                @php
                                    // Get cart count from database instead of session
                                    $userId = auth()->id();
                                    $sessionId = session('cart_session_id');

                                    $cartCount = \App\Models\Cart::where(function ($query) use ($userId, $sessionId) {
                                        if ($userId) {
    ...
    <nav class="main-nav">
        <div class="container">
            <div class="nav-wrapper">
                ...
                <!-- Mobile Menu Toggle -->
                <button class="mobile-menu-toggle d-lg-none" type="button" data-bs-toggle="offcanvas"
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="mobileMenu">
        ...
        <div class="offcanvas-body">
            <ul class="mobile-nav-list">
                ...
                <li><a href="{{ route('products.index') }}"><i class="bi bi-grid me-2"></i> {{ __('Products') }}</a>
                </li>
                <li><a href="{{ route('products.index', ['featured' => 1]) }}"><i class="bi bi-star me-2"></i>
                        {{ __('Featured') }}</a></li>
                <li><a href="{{ route('products.index', ['on_sale' => 1]) }}"><i class="bi bi-tag me-2"></i>
                        {{ __('Deals') }}</a></li>
                @auth
                    <li><a href="{{ route('orders.index') }}"><i class="bi bi-box-seam me-2"></i>
                            {{ __('My Orders') }}</a></li>
                    <li><a href="{{ route('profile.index') }}"><i class="bi bi-person me-2"></i>
                            {{ __('My Profile') }}</a></li>
                @else
                    <li><a href="{{ route('login') }}"><i class="bi bi-box-arrow-in-right me-2"></i>
                            {{ __('Login') }}</a></li>
                    <li><a href="{{ route('register') }}"><i class="bi bi-person-plus me-2"></i>
                            {{ __('Register') }}</a></li>
                @endauth
            </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6 col-6 mb-4 mb-lg-0">
                        ...
                        <ul class="footer-links">
                            <li><a href="{{ route('cms.page', ['slug' => 'about-us']) }}">{{ __('About Us') }}</a>
                            </li>

                            <li><a href="{{ route('contact.index') }}">{{ __('Contact Us') }}</a></li>

                            <li><a href="{{ route('cms.page', ['slug' => 'careers']) }}">{{ __('Careers') }}</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-6 col-6 mb-4 mb-lg-0">
                        ...
                        <ul class="footer-links">
                            <li><a href="{{ route('cms.page', ['slug' => 'help-center']) }}">{{ __('Help Center') }}</a></li>
                            <li><a href="{{ route('cms.page', ['slug' => 'shipping-info']) }}">{{ __('Shipping Info') }}</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 mb-3 mb-md-0">
                        <p class="copyright mb-0">
                            &copy; {{ date('Y') }} {{ config('app.name', 'Store') }}.
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        <div class="footer-legal-links">
                            <a href="{{ route('cms.page', ['slug' => 'privacy-policy']) }}">{{ __('Privacy Policy') }}</a>
                            <a href="{{ route('cms.page', ['slug' => 'terms-and-conditions']) }}">{{ __('Terms of Service') }}</a>
                            <a href="{{ route('cms.page', ['slug' => 'cookie-policy']) }}">{{ __('Cookie Policy') }}</a>
                            <a href="{{ route('cms.page', ['slug' => 'accessibility']) }}">{{ __('Accessibility') }}</a>
                        </div>
                    </div>
                </div>
            </div>
