    ...
    <div class="admin-wrapper">
        ...
        <aside class="admin-sidebar" id="adminSidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="nav-item has-submenu {{ request()->routeIs('admin.products.*') || request()->routeIs('admin.categories.*') ? 'active' : '' }}">
                    ...
                    <ul class="submenu">
                        @can('products.view', auth('admin')->user())
                        <li><a href="{{ route('admin.products.index') }}" class="nav-link {{ request()->routeIs('admin.products.index') ? 'active' : '' }}">{{ __('All Products') }}</a></li>
                        @endcan
                        @can('products.create', auth('admin')->user())
                        <li><a href="{{ route('admin.products.create') }}" class="nav-link {{ request()->routeIs('admin.products.create') ? 'active' : '' }}">{{ __('Add New') }}</a></li>
                        @endcan
                        @can('categories.view', auth('admin')->user())
                        <li><a href="{{ route('admin.categories.index') }}" class="nav-link {{ request()->routeIs('admin.categories.index') ? 'active' : '' }}">{{ __('Categories') }}</a></li>
                        @endcan
                    </ul>
                </li>
                @endif
                ...
                <li class="nav-item has-submenu {{ request()->routeIs('admin.reports.*') ? 'active' : '' }}">
                    ...
                    <ul class="submenu">
                        <li><a href="{{ route('admin.reports.sales') }}" class="nav-link {{ request()->routeIs('admin.reports.sales') ? 'active' : '' }}">{{ __('Sales Report') }}</a></li>
                        <li><a href="{{ route('admin.reports.products') }}" class="nav-link {{ request()->routeIs('admin.reports.products') ? 'active' : '' }}">{{ __('Products Report') }}</a></li>
                        <li><a href="{{ route('admin.reports.customers') }}" class="nav-link {{ request()->routeIs('admin.reports.customers') ? 'active' : '' }}">{{ __('Customers Report') }}</a></li>
                    </ul>
                </li>
                @endif
                ...
                <li class="nav-item has-submenu {{ request()->routeIs('admin.settings.*') ? 'active' : '' }}">
                    ...
                    <ul class="submenu">
                        <li><a href="{{ route('admin.settings.general') }}" class="nav-link {{ request()->routeIs('admin.settings.general') ? 'active' : '' }}">{{ __('General') }}</a></li>
                        @can('settings.theme', auth('admin')->user())
                        <li><a href="{{ route('admin.settings.theme') }}" class="nav-link {{ request()->routeIs('admin.settings.theme') ? 'active' : '' }}">{{ __('Theme') }}</a></li>
                        @endcan
                        @can('settings.translations', auth('admin')->user())
                        <li><a href="{{ route('admin.settings.translations') }}" class="nav-link {{ request()->routeIs('admin.settings.translations') ? 'active' : '' }}">{{ __('Translations') }}</a></li>
                        @endcan
                    </ul>
                </li>
                @endif
        ...
        <div class="admin-content">
            ...
            <header class="admin-topbar">
                ...
                <div class="topbar-right">
                    <!-- Visit Store -->
                    <a href="{{ route('home') }}" target="_blank" class="topbar-icon" title="{{ __('Visit Store') }}">
                        <i class="bi bi-shop-window"></i>
                    </a>
                    
                    <!-- Notifications -->
                    <div class="topbar-icon" title="{{ __('Notifications') }}">
                        <i class="bi bi-bell"></i>
                        @php
                            $notifications = \App\Models\Order::where('status', 'pending')->count();
                        @endphp
                        @if($notifications > 0)
                    ...
                    <!-- Messages -->
                    <div class="topbar-icon" title="{{ __('Messages') }}">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="{{ route('admin.profile') }}"><i class="bi bi-person me-2"></i>{{ __('My Profile') }}</a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.settings.general') }}"><i class="bi bi-gear me-2"></i>{{ __('Settings') }}</a></li>
