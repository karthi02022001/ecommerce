                    ...
                    <div class="products-grid" id="productsGrid">
                        ...
                        <div class="product-card-modern">
                            <div class="product-image-container">
                                ...
                                @else
                                <img src="https://via.placeholder.com/400x260?text={{ urlencode($product->name()) }}" alt="{{ $product->name() }}">
                                @endif
                                ...
                                <div class="product-actions-overlay">
                                    ...
                                    <button class="action-btn-circle" title="{{ __('Add to Wishlist') }}">
                            ...
                            <div class="product-info-modern">
                                ...
                                <p class="product-description">{{ Str::limit($product->shortDescription(), 80) }}</p>
                                @endif
                        ...
                        <div class="col-12">
                            <div class="empty-state">
                                ...
                                <p>{{ __('This category is currently empty. Check back soon or browse other categories.') }}</p>
